...
Le modèle d'éveil est entraîné sur l'anglais natif : prononce « Hey
Jarvis » à l'anglaise (« héï djâ-vis ») — l'accent français naturel passe
sous le radar du modèle (mesuré : < 0,08 contre 0,83 en accent forcé).
Seuil réglable : JARVIS_WAKE_THRESHOLD (défaut 0,30). Projet futur : un
modèle custom entraîné sur des échantillons accentués.
